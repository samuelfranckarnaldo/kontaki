...
function showSetup() {
  ...
  overlay.innerHTML = [
    ...
    '<div id="setup-header" style="padding:32px 24px 20px;text-align:center;flex-shrink:0;border-bottom:1px solid #f4f4f5;position:relative">',
      ...
      '<button id="setup-restore-console-btn" onclick="window._openRestoreFromConsole()" style="display:inline-flex;align-items:center;gap:8px;background:#f5f3ff;border:1.5px solid #ddd6fe;border-radius:12px;padding:9px 14px;cursor:pointer;font-size:12.5px;font-weight:700;color:#5b21b6;font-family:inherit;transition:opacity .2s ease">',
