...
var ACTION_META = {
  ...
  transfer:      { label: "transferiu stock",       icon: "arrow-right-left", color: "#2563eb" },
  purchase:      { label: "registou compra",        icon: "package-plus",     color: "#16a34a" },
  edit_purchase: { label: "editou compra",          icon: "pencil",           color: "#2563eb" },
