...
function showErrorBoundary(message, file, line) {
  // Não mostrar se já há um modal de erro
  ...
  div.innerHTML =
    ...
    '<button onclick="document.getElementById(\'error-boundary\').remove()" ' +
    'style="padding:12px 24px;background:#5b21b6;color:#fff;border:none;border-radius:10px;' +
    'font-size:14px;font-weight:600;cursor:pointer;margin-bottom:8px">Tentar novamente</button>' +
    '<button onclick="window.location.reload()" ' +
    'style="padding:10px 24px;background:#f4f4f5;color:#71717a;border:none;border-radius:10px;' +
    'font-size:13px;cursor:pointer">Recarregar app</button>';
